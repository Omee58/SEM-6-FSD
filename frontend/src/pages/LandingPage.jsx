...
import {
  ...
  MapPin, Instagram, Facebook, Twitter, CheckCircle
} from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-center gap-2"><Phone size={14} /> +91 98001 23456</li>
                <li className="flex items-center gap-2"><Mail size={14} /> hello@shadiseva.com</li>
                <li className="flex items-start gap-2"><MapPin size={14} className="mt-0.5 shrink-0" /> Connaught Place, New Delhi, India</li>
              </ul>
            </div>
          </div>
